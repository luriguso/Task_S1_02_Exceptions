package level_2.exercise_1.main;

import level_2.exercise_1.classData.Input;
...
public class main {
    public static void main(String[] args) throws readCharException, readStringException, readYesOrNotException {
        ...
        String name = Input.readString("Enter your name", scanner);
        System.out.println("The name is " + name);
        System.out.println("The name is correct, bye bye...");
